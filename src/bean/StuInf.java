...
public class StuInf {
	//verify_me
	private String yb_userid="";//�װ��û�id
	private String yb_realname="";//��ʵ����
	private String yb_schoolname="";//����ѧУ����
	private String yb_collegename="";//����ѧԺ����
	private String yb_classname="";//���ڰ༶����
	private String yb_enteryear="";//��ѧ���
	private String yb_studentid="";//ѧ��
	private String yb_examid="";//׼��֤��
	private String yb_admissionid="";//¼ȡ֪ͨ���
	private String yb_employid="";//����
	//real_me
	private String yb_sex="";//�Ա�
